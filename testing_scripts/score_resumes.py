...
def append_scores(labeled_df: pd.DataFrame, job_description: str, CV_column_name: str, verbose: bool = False):
    '''
    ...
    score_column_name: str = f"{CV_column_name} Score"
